...
const MicrosoftLogo: React.FC<{ size?: number }> = ({ size = 40 }) => {
const half = size / 2;
const gap = size * 0.06;
return (
<div
...
const msSpring = spring({
frame,
fps,
delay: 32,
config: { damping: 200 },
});
const msOpacity = interpolate(msSpring, [0, 1], [0, 1]);
const msY = interpolate(msSpring, [0, 1], [20, 0]);
...
>
<GlowText fontSize={88} fontWeight={900}>
DebugMCP
</GlowText>
</div>
